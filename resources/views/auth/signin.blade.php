...
<body>
    ...
    <div id="alert-3"
        class="fixed bottom-5 left-5 flex items-center p-4 mb-4 text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400"
        role="alert">
        ...
        <div class="ms-3 text-sm font-medium">
            {{ session('Gagal') ?? session('Berhasil') }}
        </div>
        <button type="button"
