    ...
    <div
        ...
        <div class="py-8 px-8 max-auto">
            <img class="block h-28 w-28 rounded-full"
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTEwWiL7wBcIZIiNm-UFxKGTRf6Gcefdw2aAg&usqp=CAU" alt="{{ $user->fullname }}" />
        </div>
        <div class="flex items-center sm:text-left">
            <div class="space-y-0.5">
                <div class="inline-flex">
                    ...
                    <p><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 20" fill="currentColor" class="ml-1 w-6 h-6">
